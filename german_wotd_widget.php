<?php
/*
Plugin Name: German Word of the Day
Plugin URI: http://www.declan-software.com/german
Description: Adds a daily German Word of the Day (with audio) widget to the WordPress sidebar. 
...
function widget_germanwotdwidget_init() 
{
...
add_action('widgets_init', 'widget_germanwotdwidget_init');
